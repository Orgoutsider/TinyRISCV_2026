...
$tbFile = "tinyriscv_soc_uart_download_pwm_tb.v"
$vcdFile = "tinyriscv_soc_uart_download_pwm_tb.vcd"

if ($Out -eq "") {
    $Out = Join-Path $buildDir "tinyriscv_soc_uart_download_pwm_tb.vvp"
}
