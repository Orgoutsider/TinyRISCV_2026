...
module rib(
    ...
    // slave 6 interface
    output reg[`MemAddrBus] s6_addr_o,     // 从设备4读、写地址
    output reg[`MemBus] s6_data_o,         // 从设备4写数据
    input wire[`MemBus] s6_data_i,         // 从设备4读取到的数据
    output reg s6_we_o,                    // 从设备4写标志

    // slave 7 interface
    output reg[`MemAddrBus] s7_addr_o,     // 从设备5读、写地址
    output reg[`MemBus] s7_data_o,         // 从设备5写数据
    input wire[`MemBus] s7_data_i,         // 从设备5读取到的数据
    output reg s7_we_o,                    // 从设备5写标志
